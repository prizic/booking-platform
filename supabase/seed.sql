...
values
  ...
  ('00000000-0000-0000-0000-000000000000', 'a1000000-0000-0000-0000-000000000005', 'authenticated', 'authenticated', 'journey-a@example.invalid', '', '2026-09-05 00:00:00+00', '{"provider":"email","providers":["email"]}', '{}', '2026-09-05 00:00:00+00', '2026-09-05 00:00:00+00'),
...
values
  ('a5600000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'location', 'a5000000-0000-0000-0000-000000000001', 'America/New_York'),
  ('b5600000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', 'location', 'b5000000-0000-0000-0000-000000000001', 'America/Denver');
insert into app.weekly_schedules (id, tenant_id, schedule_scope_id, day_of_week, start_minute, end_minute)
values
  ('a5700000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'a5600000-0000-0000-0000-000000000001', 1, 540, 1020),
  ('a5700000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000001', 'a5600000-0000-0000-0000-000000000001', 2, 540, 1020),
  ('a5700000-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000001', 'a5600000-0000-0000-0000-000000000001', 3, 540, 1020),
  ('a5700000-0000-0000-0000-000000000004', 'a0000000-0000-0000-0000-000000000001', 'a5600000-0000-0000-0000-000000000001', 4, 540, 1020),
  ('a5700000-0000-0000-0000-000000000005', 'a0000000-0000-0000-0000-000000000001', 'a5600000-0000-0000-0000-000000000001', 5, 540, 1020),
  ('b5700000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', 'b5600000-0000-0000-0000-000000000001', 1, 540, 1020);
...
values
  ...
  -- Issue #94. The browser journey's own staff member, so the bookable fixture
  -- below borrows nobody else's membership.
  ('a3000000-0000-0000-0000-000000000006', 'a0000000-0000-0000-0000-000000000001', 'a1000000-0000-0000-0000-000000000005', 'a2000000-0000-0000-0000-000000000001', 'active', 1, '2026-09-05 00:00:00+00', null),
...
values
  ...
  ('a0000000-0000-0000-0000-000000000001', 'a3000000-0000-0000-0000-000000000006', 'a5000000-0000-0000-0000-000000000002', '2026-09-05 00:00:00+00'),
...
-- ---------------------------------------------------------------------------
-- Issue #94. One bookable fixture, so a browser can actually finish a booking.
--
-- Deliberately on location A two, which until now had no schedule and therefore
-- offered nothing. Every pgTAP suite that asserts a slot count does so against
-- location A one, and the availability, schedule, hold and booking suites insert
-- their own staff; giving a previously empty location a staff member and a week
-- leaves all of those numbers exactly where they were.
--
-- Location A two is America/Chicago, which is also useful: a journey that books
-- across a zone boundary is the one that catches a UTC assumption.
-- ---------------------------------------------------------------------------

insert into app.catalog_location_revisions (id,tenant_id,location_id,revision,locale,state,name,description,address,canonical_path,publication_id,published_at) values
 ('a7310000-0000-0000-0000-000000000003','a0000000-0000-0000-0000-000000000001','a5000000-0000-0000-0000-000000000002',1,'en','published','Riverside','Our second location.','River Road','/locations/location-a-two','a7000000-0000-0000-0000-000000000001','2026-09-05 00:00:00+00'),
 ('a7310000-0000-0000-0000-000000000004','a0000000-0000-0000-0000-000000000001','a5000000-0000-0000-0000-000000000002',1,'ar','published','ضفة النهر','موقعنا الثاني.','طريق النهر','/locations/location-a-two','a7000000-0000-0000-0000-000000000001','2026-09-05 00:00:00+00');

insert into app.catalog_service_locations (tenant_id,service_id,location_id)
values ('a0000000-0000-0000-0000-000000000001','a7200000-0000-0000-0000-000000000001','a5000000-0000-0000-0000-000000000002');

insert into app.schedule_scopes (id, tenant_id, scope_kind, location_id, time_zone)
values ('a5600000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000001', 'location', 'a5000000-0000-0000-0000-000000000002', 'America/Chicago');

insert into app.weekly_schedules (id, tenant_id, schedule_scope_id, day_of_week, start_minute, end_minute)
values
  ('a5700000-0000-0000-0000-000000000006', 'a0000000-0000-0000-0000-000000000001', 'a5600000-0000-0000-0000-000000000002', 1, 540, 1020),
  ('a5700000-0000-0000-0000-000000000007', 'a0000000-0000-0000-0000-000000000001', 'a5600000-0000-0000-0000-000000000002', 2, 540, 1020),
  ('a5700000-0000-0000-0000-000000000008', 'a0000000-0000-0000-0000-000000000001', 'a5600000-0000-0000-0000-000000000002', 3, 540, 1020),
  ('a5700000-0000-0000-0000-000000000009', 'a0000000-0000-0000-0000-000000000001', 'a5600000-0000-0000-0000-000000000002', 4, 540, 1020),
  ('a5700000-0000-0000-0000-00000000000a', 'a0000000-0000-0000-0000-000000000001', 'a5600000-0000-0000-0000-000000000002', 5, 540, 1020);

insert into app.staff_profiles (id, tenant_id, membership_id, public_name, status, revision, created_at, updated_at)
values ('af000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'a3000000-0000-0000-0000-000000000006', 'Journey Fixture', 'active', 1, '2026-09-05 00:00:00+00', '2026-09-05 00:00:00+00');

insert into app.staff_locations (tenant_id, staff_id, location_id, created_at)
values ('a0000000-0000-0000-0000-000000000001', 'af000000-0000-0000-0000-000000000001', 'a5000000-0000-0000-0000-000000000002', '2026-09-05 00:00:00+00');
insert into app.staff_services (tenant_id, staff_id, service_id, created_at)
values ('a0000000-0000-0000-0000-000000000001', 'af000000-0000-0000-0000-000000000001', 'a7200000-0000-0000-0000-000000000001', '2026-09-05 00:00:00+00');
insert into app.staff_service_locations (tenant_id, staff_id, service_id, location_id, created_at)
values ('a0000000-0000-0000-0000-000000000001', 'af000000-0000-0000-0000-000000000001', 'a7200000-0000-0000-0000-000000000001', 'a5000000-0000-0000-0000-000000000002', '2026-09-05 00:00:00+00');

-- The staff member's own week. A location scope is opening hours; this is the
-- one that says somebody is actually there to be booked.
insert into app.schedule_scopes (id, tenant_id, scope_kind, location_id, staff_id, time_zone)
values ('af100000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'staff', 'a5000000-0000-0000-0000-000000000002', 'af000000-0000-0000-0000-000000000001', 'America/Chicago');
insert into app.weekly_schedules (id, tenant_id, schedule_scope_id, day_of_week, start_minute, end_minute)
values
  ('af200000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'af100000-0000-0000-0000-000000000001', 1, 540, 1020),
  ('af200000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000001', 'af100000-0000-0000-0000-000000000001', 2, 540, 1020),
  ('af200000-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000001', 'af100000-0000-0000-0000-000000000001', 3, 540, 1020),
  ('af200000-0000-0000-0000-000000000004', 'a0000000-0000-0000-0000-000000000001', 'af100000-0000-0000-0000-000000000001', 4, 540, 1020),
  ('af200000-0000-0000-0000-000000000005', 'a0000000-0000-0000-0000-000000000001', 'af100000-0000-0000-0000-000000000001', 5, 540, 1020);
