...
select is((select outcome from api_v1.deactivate_staff_v1('a0000000-0000-0000-0000-000000000001','a8000000-0000-0000-0000-000000000001','reassign','a8000000-0000-0000-0000-000000000002',gen_random_uuid(),'staff unavailable')), 'reassign','deactivation records explicit reassignment outcome');
