...
select is(
  (with changed as (
    update app.tenant_settings set revision = revision + 1
    where tenant_id = 'a0000000-0000-0000-0000-000000000001' returning 1
...
select is(
  (with changed as (
    update app.tenant_settings set revision = revision + 1
    where tenant_id = 'b0000000-0000-0000-0000-000000000001' returning 1
  ) select count(*)::integer from changed),
  0,
