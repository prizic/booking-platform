// GENERATED by scripts/bundle-edge-shared.mjs from packages/email/src/worker.ts.
// Do not edit. Change the package and run `pnpm bundle:edge`.
import { renderNotificationEmail, type NotificationTemplateKey } from "./templates.ts";
