// GENERATED by scripts/bundle-edge-shared.mjs from packages/email/src/templates.ts.
// Do not edit. Change the package and run `pnpm bundle:edge`.
import type { ContractLocale } from "./contracts.ts";
...
const copy: Record<NotificationTemplateKey, Record<ContractLocale, TemplateCopy>> = {
  "auth.sign_in_link": {
    ar: {
      ...
      body: [
        "استخدم الرابط التالي لتسجيل الدخول. صالح لمرة واحدة فقط.",
        "{actionUrl}",
    ...
    en: {
      ...
      body: [
        "Use the link below to sign in. It works once.",
        "{actionUrl}",
        "If you did not ask for this link, ignore this message.",
      ],
    },
  },
  "auth.password_reset": {
    ar: {
      subject: "إعادة تعيين كلمة المرور في {brandName}",
      heading: "إعادة تعيين كلمة المرور",
      body: [
        "استخدم الرابط التالي لاختيار كلمة مرور جديدة. صالح لمرة واحدة فقط.",
        "{actionUrl}",
        "إذا لم تطلب ذلك، فكلمة مرورك لم تتغير.",
      ],
    },
    en: {
      ...
      body: [
        ...
        "{actionUrl}",
        "If you did not ask for this, your password has not changed.",
      ],
    },
  },
  "auth.email_change": {
    ar: {
      subject: "تأكيد بريدك الإلكتروني الجديد في {brandName}",
      heading: "تأكيد البريد الإلكتروني",
      body: [
        "أكد عنوان بريدك الإلكتروني الجديد عبر الرابط التالي.",
        "{actionUrl}",
        "لن يتغير عنوانك حتى تؤكده.",
      ],
    },
    en: {
      ...
      body: [
        "Confirm your new email address with the link below.",
        "{actionUrl}",
        "Your address does not change until you confirm it.",
      ],
    },
  },
  "booking.confirmed": {
