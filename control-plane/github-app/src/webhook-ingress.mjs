  ...
  return {
    async handle({ headers, rawBody }) {
      ...
      if (
        ...
        return { status: 401, code: "github_signature_invalid" };
      if (typeof deliveryId !== "string" || typeof eventName !== "string")
        return { status: 400, code: "github_delivery_invalid" };
      let payload;
      try {
        payload = JSON.parse(rawBody.toString("utf8"));
      } catch {
        return { status: 400, code: "github_payload_invalid" };
      }
      const record = {
        deliveryId,
        ...
        repositoryExternalId:
          typeof payload?.repository?.node_id === "string"
